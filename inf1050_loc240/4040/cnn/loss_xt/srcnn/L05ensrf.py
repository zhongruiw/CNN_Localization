...
def ensrf(ztruth, zics_total, zobs_total):
    # -------------------- model setting --------------------
    model = srcnn(batch_size=4)
    model.load_weights('/home/lllei/AI_localization/L05/e2000_inf1050_e40_inf1050_loc240/train/ai/CNN/Loss_xt/SRCNN_Dong/tune/219_21_5/my_weights/srcnn')
