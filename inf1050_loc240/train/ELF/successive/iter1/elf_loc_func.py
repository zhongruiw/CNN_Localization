...
def ensrf(ztruth, zics_total, zobs_total):
    ...
    # save
    np.save('elf.npy', elf)
    np.save('/scratch/lllei/inf1050_loc240/train/elf/successive/inf1000/iter1/inc_t.npy', inc_t)
    np.save('/scratch/lllei/inf1050_loc240/train/elf/successive/inf1000/iter1/inc_p.npy', inc_p)
