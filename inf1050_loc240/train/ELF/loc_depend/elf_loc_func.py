...
# version: 2.6
# update: add loc_dep selection; multiple inf,git repo; allow deflation; fix bug, distance 481,not 480
...
obsfname = pjoin(data_dir, 'obs_ms3_err1_240s_6h_25y_gamma.mat')
truthfname = pjoin(data_dir, 'zt_25year_ms3_6h.mat')
gammafname = pjoin(data_dir, 'gamma_k2_theta40.npy')
...
Hk = H('gamma_weighted', model_size, obs_density, gamma=gamma)
