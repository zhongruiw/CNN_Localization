...
def ensrf(ztruth, zics_total, zobs_total):
    ...
    betaa = np.load('/home/lllei/AI_localization/L05/F15/avrgobs/00625/train/reg/distance_only/debug_481/without_res/reg_smsp.npy')
    ...
    print('prior reg error = {0:.6f}'.format(prior_indeself_err))
    print('analy gc error = {0:.6f}'.format(analy_err))
    print('analy reg_loc error = {0:.6f}'.format(analy_indeself_err))
    ...
    np.save('prior_spread_rmse_gc.npy', prior_spread_rmse)
    np.save('prior_spread_rmse_reg_2d.npy', prior_spread_inde_rmse)
    np.save('analy_spread_rmse_gc.npy', analy_spread_rmse)
    np.save('analy_spread_rmse_reg_2d.npy', analy_spread_inde_rmse)
